...
import com.ar.ui_practice.ui_component.carousel.utils.CarouselItemDecoration
import com.ar.ui_practice.ui_component.carousel.utils.setImage
...
open class FiniteCarouselAdapter(
    ...
    override fun onBindViewHolder(
        ...
        if (holder.binding is ItemCarouselBinding) {
            ...
            if(showCaption){
                item.caption.let{
                    holder.binding.tvCaption.text = it
                }
            }
            else{

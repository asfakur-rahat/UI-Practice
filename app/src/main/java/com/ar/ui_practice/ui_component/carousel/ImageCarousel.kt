package com.ar.ui_practice.ui_component.carousel
...
import com.ar.ui_practice.databinding.ItemCarouselBinding
import com.ar.ui_practice.ui_component.carousel.adapter.FiniteCarouselAdapter
import com.ar.ui_practice.ui_component.carousel.adapter.InfiniteCarouselAdapter
import com.ar.ui_practice.ui_component.carousel.listener.CarouselListener
import com.ar.ui_practice.ui_component.carousel.listener.CarouselOnScrollListener
...
import com.ar.ui_practice.ui_component.carousel.utils.CarouselLinearLayoutManager
import com.ar.ui_practice.ui_component.carousel.utils.LinearStartSnapHelper
import com.ar.ui_practice.ui_component.carousel.utils.Scroller
import com.ar.ui_practice.ui_component.carousel.utils.dpToPx
import com.ar.ui_practice.ui_component.carousel.utils.getSnapPosition
import com.ar.ui_practice.ui_component.carousel.utils.spToPx
import com.ar.ui_practice.ui_component.indicator.Indicator
...
class ImageCarousel(
    ...
    private val carouselTypeArray =
        arrayOf(
            CarouselType.BLOCK,
            CarouselType.SHOWCASE,
        )

    private val carouselGravityArray =
        arrayOf(
...
//        }
    ...
    var showSubtitle = false
        set(value) {
            ...
            tvSubtitle.visibility = if (showSubtitle) View.VISIBLE else View.GONE
        }
    ...
    var subtitleMargin: Int = 0
        set(value) {
            ...
            val subtitleMarginParams = tvSubtitle.layoutParams as LayoutParams
            subtitleMarginParams.setMargins(
                0,
                0,
                0,
                captionMargin,
            )
            subtitleMarginParams.goneBottomMargin = captionMargin
            tvSubtitle.layoutParams = subtitleMarginParams
        }
    ...
    var subtitleTextSize: Int = 0
        set(value) {
            ...
            tvSubtitle.setTextSize(TypedValue.COMPLEX_UNIT_PX, captionTextSize.toFloat())
        }
...
//        }
    ...
    private fun initViews() {
        ...
        //val carousel = LayoutInflater.from(context).inflate(R.layout.item_carousel, this)

        recyclerView = carouselView.findViewById(R.id.recyclerView)

        tvCaption = ItemCarouselBinding.inflate(LayoutInflater.from(context)).root.findViewById(R.id.tv_caption)
        tvSubtitle = ItemCarouselBinding.inflate(LayoutInflater.from(context)).root.findViewById(R.id.tv_subtitle)
            ...
            try {
                ...
                captionTextSize =
                    getDimension(
                        ...
                        17.spToPx(context).toFloat(),
                    ).toInt()
                showSubtitle =
                    getBoolean(
                        R.styleable.ImageCarousel_showSubTitle,
                        true,
                    )

                subtitleMargin =
                    getDimension(
                        R.styleable.ImageCarousel_subtitleMargin,
                        0.dpToPx(context).toFloat(),
                    ).toInt()

               subtitleTextSize =
                    getDimension(
                        R.styleable.ImageCarousel_subtitleTextSize,
        ...
        recyclerView.addOnScrollListener(
            object : RecyclerView.OnScrollListener() {
                override fun onScrolled(
                    ...
                    val position =
                        snapHelper?.getSnapPosition(recyclerView.layoutManager)
                            ?: NO_POSITION
                    ...
                    // Update the built-in subtitle
                    if (showSubtitle && currentRealPosition >= 0) {
                        dataItem = adapter?.getItem(currentRealPosition)

                        dataItem?.apply {
                            tvSubtitle.text = this.subtitle
                        }
                    }
     ...
     */
    fun setIndicator(newIndicator: Indicator) {
        indicator?.apply {
